...
.team-section { position:relative; overflow:hidden; padding-bottom:8px; }.team-section:before { content:''; position:absolute; left:7%; right:7%; top:56%; border-top:1px solid rgba(98,217,230,.12); pointer-events:none; }.team-section:after { content:'·   ·   ·'; position:absolute; left:50%; top:calc(56% - 9px); transform:translateX(-50%); color:rgba(125,226,163,.38); font:500 1rem 'DM Mono',monospace; letter-spacing:5.2rem; pointer-events:none; }.team-intro { max-width:650px; margin-bottom:30px; }.team-intro h2 { font-size:clamp(2.5rem,5vw,5.7rem); line-height:.9; letter-spacing:-.085em; margin:0 0 19px; }.team-intro p { color:#aebdb8; font-size:.9rem; line-height:1.7; max-width:440px; margin:0; }.team-grid { display:grid; grid-template-columns:repeat(3,1fr); gap:18px; position:relative; z-index:1; }.team-card { min-height:330px; padding:31px 29px 27px; position:relative; overflow:hidden; display:flex; flex-direction:column; justify-content:space-between; background:rgba(13,31,28,.62); border:1px solid rgba(220,245,237,.13); border-radius:22px; box-shadow:0 24px 70px rgba(0,0,0,.25),0 0 45px rgba(98,217,230,.06); backdrop-filter:blur(22px); transition:transform .3s ease,border-color .3s ease,background .3s ease,box-shadow .3s ease; }.team-card:before { content:''; position:absolute; width:190px; height:190px; right:-90px; top:-72px; border-radius:50%; background:radial-gradient(circle,rgba(98,217,230,.14),transparent 68%); transition:opacity .3s ease,transform .3s ease; }.team-card:nth-child(2):before { left:-92px; right:auto; top:45%; background:radial-gradient(circle,rgba(125,226,163,.13),transparent 68%); }.team-card:nth-child(3):before { right:12%; top:auto; bottom:-120px; background:radial-gradient(circle,rgba(98,217,230,.12),transparent 68%); }.team-card:hover { transform:translateY(-6px); border-color:rgba(220,245,237,.32); background:rgba(18,40,36,.78); box-shadow:0 28px 80px rgba(0,0,0,.34),0 0 55px rgba(98,217,230,.1); }.team-card:hover:before { opacity:1; transform:scale(1.18); }.team-card-top,.team-card-bottom { position:relative; z-index:1; display:flex; justify-content:space-between; align-items:center; }.team-number { color:var(--cyan); font:500 1.05rem 'DM Mono',monospace; transition:text-shadow .3s ease;color:rgba(98,217,230,.8); }.team-card:hover .team-number { text-shadow:0 0 18px rgba(98,217,230,.65); }.team-mark { color:rgba(220,245,237,.34); font:500 .8rem 'DM Mono',monospace; }.team-name { position:relative; z-index:1; margin:56px 0 8px; font-size:clamp(1.7rem,2.7vw,3.05rem); line-height:.92; letter-spacing:-.075em; max-width:240px; }.team-id { position:relative; z-index:1; color:#d9ebe4; font:500 1rem 'DM Mono',monospace; letter-spacing:.08em; }.team-label { color:var(--green); font:500 .62rem 'DM Mono',monospace; letter-spacing:.13em; }.team-year { color:var(--muted); font:500 .62rem 'DM Mono',monospace; letter-spacing:.09em; }.footer-team { display:grid; gap:7px; color:#9eafaa; line-height:1.8; }.footer-team strong { color:var(--ink); font-weight:500; }.footer-team span { color:var(--muted); }
@media (max-width:1020px) { .team-grid { grid-template-columns:repeat(2,1fr); }.team-card:last-child { grid-column:1 / -1; max-width:calc(50% - 9px); width:100%; justify-self:center; } }
@media (max-width:800px) { .block-container{padding:1.5rem 1rem 3rem}.top-nav{width:100%;margin-bottom:18px;padding:10px 11px 10px 14px;top:7px}.top-nav + .anchor{height:58px}.brand{font-size:.6rem;gap:7px}.brand small{display:none}.nav-links{display:none}.mobile-menu{display:block;position:relative}.mobile-menu summary{list-style:none;cursor:pointer;color:var(--green);font:500 .65rem 'DM Mono',monospace;letter-spacing:.1em;padding:9px 8px}.mobile-menu summary::-webkit-details-marker{display:none}.mobile-menu[open] summary{background:var(--glass-hi);border-radius:8px}.mobile-menu nav{position:absolute;right:0;top:42px;display:grid;gap:3px;min-width:165px;padding:8px;background:rgba(10,25,23,.95);border:1px solid var(--line);border-radius:12px;box-shadow:0 16px 45px rgba(0,0,0,.35);backdrop-filter:blur(20px)}.mobile-menu a{display:block}.mobile-menu a span{color:rgba(98,217,230,.7);margin-right:5px}.hero{min-height:520px;padding:29px 25px;align-items:start}.hero-copy{width:100%}.hero h1{font-size:3.7rem}.hero-orbit{top:54%;right:10%;width:230px;height:230px}.hero-grid{width:100%;height:36%}.metadata{gap:8px;font-size:.59rem;flex-wrap:wrap}.control-bar{top:5px;padding:18px 16px}.control-title{margin-bottom:11px}.rank-row{grid-template-columns:27px 1fr 70px}.rank-row .row-stat{display:none}.leader{min-height:300px}.ring{width:92px;height:92px}.ring:after{width:71px;height:71px}.section-kicker{margin-top:45px;display:block}.section-kicker p{margin:7px 0 0}.team-grid{grid-template-columns:1fr}.team-card:last-child{grid-column:auto;max-width:none}.team-card{min-height:290px;padding:27px 24px}.team-name{margin-top:40px}.team-section:before,.team-section:after{display:none}.footer{display:block;line-height:2.2} }
</style>
...
st.markdown('''<nav class="top-nav" aria-label="Primary navigation"><div class="brand"><i class="status-dot"></i><span>♻ <strong>E-WASTE INTELLIGENCE</strong></span><small>2022</small></div><div class="nav-links"><a href="#overview"><span>01</span>OVERVIEW</a><a href="#rankings"><span>02</span>RANKINGS</a><a href="#analysis"><span>03</span>ANALYSIS</a><a href="#compare"><span>04</span>COMPARE</a><a href="#data"><span>05</span>DATA</a><a href="#team"><span>06</span>TEAM</a></div><details class="mobile-menu"><summary>MENU ≡</summary><nav><a href="#overview"><span>01</span>OVERVIEW</a><a href="#rankings"><span>02</span>RANKINGS</a><a href="#analysis"><span>03</span>ANALYSIS</a><a href="#compare"><span>04</span>COMPARE</a><a href="#data"><span>05</span>DATA</a><a href="#team"><span>06</span>TEAM</a></nav></details></nav>''', unsafe_allow_html=True)
...
section("05", "DATA EXPLORER", "Inspect and download the filtered source rows.")
...
st.markdown('''<div id="team" class="anchor"></div><section class="team-section"><div class="section-kicker"><span class="number">06</span><div class="team-intro"><div class="eyebrow">THE TEAM</div><h2>THE PEOPLE<br>BEHIND THE DATA.</h2><p>Built, analyzed and visualized as a collaborative data visualization project.</p></div></div><div class="team-grid"><article class="team-card"><div class="team-card-top"><span class="team-number">01 /</span><span class="team-mark">TEAM MEMBER</span></div><div><h3 class="team-name">YASH<br>PATIL</h3><div class="team-id">24101A0065</div></div><div class="team-card-bottom"><span class="team-label">PROJECT TEAM</span><span class="team-year">PROJECT 2022</span></div></article><article class="team-card"><div class="team-card-top"><span class="team-number">02 /</span><span class="team-mark">TEAM MEMBER</span></div><div><h3 class="team-name">GAURAV<br>GHUDE</h3><div class="team-id">24101A0061</div></div><div class="team-card-bottom"><span class="team-label">PROJECT TEAM</span><span class="team-year">PROJECT 2022</span></div></article><article class="team-card"><div class="team-card-top"><span class="team-number">03 /</span><span class="team-mark">TEAM MEMBER</span></div><div><h3 class="team-name">SAYALI<br>ANDHALE</h3><div class="team-id">24101A0024</div></div><div class="team-card-bottom"><span class="team-label">PROJECT TEAM</span><span class="team-year">PROJECT 2022</span></div></article></div></section><div class="footer"><div class="footer-team"><strong>E-WASTE RECYCLING INTELLIGENCE</strong><span>2022 DATASET · PROJECT TEAM</span><span>YASH PATIL · 24101A0065</span><span>GAURAV GHUDE · 24101A0061</span><span>SAYALI ANDHALE · 24101A0024</span></div><span>Generated from the supplied country-level dataset · Kt = kilotonnes</span></div>''', unsafe_allow_html=True)
